...
----------------------------------------------------------------------->
<cfcomponent hint="Feed reader helper"
			 output="false">
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->

	<cffunction name="init" access="public" returntype="ReaderUtil" output="false">
		<cfscript>
			return this;
		</cfscript>
	</cffunction>
...
<!--------------------------------------------------------------------------------------------------->
	...
	<cffunction name="parseAtomItems" access="public" returntype="any" hint="Parse the items an return an array of structures" output="false" >
		...
		<cfscript>
			...
			var node = "";
			var loop = "";
			var oUtilities = createObject( "component", "DateUtils" );
