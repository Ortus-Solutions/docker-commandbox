...
----------------------------------------------------------------------->
<cfcomponent extends="SharedGenerator"
...
<!------------------------------------------- VERIFICATION METHODS ---------------------------------->
	...
	<cffunction name="verifyFeed" output="false" access="public" returntype="void" hint="Verify the RSS 2 feed structure and append auto-generated properties">
		...
		<cfif throwErr>
			<cfthrow type="RSS2Generator.InvalidFeedStructure"
					 message="The generated RSS feed has some problems which makes it incomplete: #invalidList# #invalidDsp#">
		</cfif>
	</cffunction>
