...
curl --location 'http://integration.stg.ortussolutions.com/artifacts/ortussolutions/commandbox/4.0.0-SNAPSHOT/commandbox-bin-4.1.0-SNAPSHOT.zip' -o /tmp/box.zip
